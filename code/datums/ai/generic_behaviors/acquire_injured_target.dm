/datum/bt_node/ai_behavior/retrieve_injured_target
	///where do we save our target
	var/target_key

/datum/bt_node/ai_behavior/retrieve_injured_target/perform(seconds_per_tick, datum/ai_controller/controller)
